...
public class FirstActivity extends Activity {
	...
	int backgroundColorLists[] = { R.drawable.gradient_dark_green,
	...
	Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 1:
				...
				if (currLayout < 1) {
					l2.setBackgroundResource(backgroundColorLists[currLayout]);// set
																				// current
																				// layer
																				// as
																				// first
					...
					l1.setBackgroundResource(backgroundColorLists[currLayout + 1]);// set
																					// next
																					// layer
					currLayout++;
				} else // ==4
				{
					l2.setBackgroundResource(backgroundColorLists[currLayout]);// set
																				...
																				// layer
					l2.setVisibility(View.VISIBLE);// set visible
					l1.setBackgroundResource(backgroundColorLists[0]);// set
																		// next
																		// layer
					currLayout = 0;
				}
				...
				final Animation fadeOut = AnimationUtils.loadAnimation(
						FirstActivity.this, R.anim.fade_out);
				final Animation fadeIn = AnimationUtils.loadAnimation(
						FirstActivity.this, R.anim.fade_in);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.HeartRateButton).setOnClickListener(
		...
		findViewById(R.id.ViewResultButton).setOnClickListener(
				new View.OnClickListener() {
					@Override
					public void onClick(View v) {
						// Inform the user the button has been clicked
